...
public class program3 {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("12.- Mostrar primos aleatorios");
            System.out.println("13.- Comprobar primos no aleatorios");
            System.out.println("14.- Calcular hipoteca");
            ...
            switch (opcion) {
                ...
                case 11:
                    ...
                    if (sc.hasNextInt()) {
                        ...
                        System.out.println(
                            misMetodos.esPrimoMuyOptimizado(esPrimo)
                        );
                    }
                    break;
                case 12:
                    System.out.print(
                        "Introduzca el rango de numeros aleatorios: "
                    );
                    if (sc.hasNextInt()) {
                        int rango = sc.nextInt();
                        System.out.println(
                            "Introduzca cuantos numeros aleatorios dentro del rango"
                        );
                        int cantRandom = sc.nextInt();
                        for (int i = 1; i <= cantRandom; i++) {
                            int numRandom = misMetodos.numRandomAscii(rango);
                            System.out.println(
                                numRandom +
                                    " " +
                                    misMetodos.esPrimoMuyOptimizado(numRandom)
                            );
                        }
                    }
                    break;
                case 13:
                    System.out.print(
                        "Introduzca el rango de primos a comprobar: "
                    );
                    if (sc.hasNextInt()) {
                        int rango = sc.nextInt();
                        for (int i = 1; i <= rango; i++) {
                            System.out.println(
                                i + " " + misMetodos.esPrimoMuyOptimizado(i)
                            );
                        }
                    }
                    break;
                case 14:
                    System.out.print("Introduzca el valor de la vivienda: ");
                    if (sc.hasNextInt()) {
                        int valor = sc.nextInt();
                        System.out.println("Introduzca el interes");
                        double interes = sc.nextDouble();
                        System.out.println("Introduzca a cuantos años");
                        double años = sc.nextDouble();
                        for (int i = 1; i <= años; i++) {
                            System.out.println(
                                i +
                                    " " +
                                    misMetodos.deposito_bancario(
                                        valor,
                                        interes,
                                        años
                                    )
